...
```text
A2 Draft Apply Safety through D6 Hash Routing and deep links, plus C4 Voice Reliability and E2 Report Preview/Print
```
...
- In-app report preview with a polished field-handoff layout, summary band, numbered sections, print styling for Save as PDF/share as PDF, and preserved copy/download text fallbacks
...
While that physical-device check is pending, the next code slice is E1 Daily Activity Snapshot.
