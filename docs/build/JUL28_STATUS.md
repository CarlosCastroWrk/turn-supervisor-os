...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| A Field shell | `/Users/los/Documents/PDS-jul28-field-shell` | `codex/jul28-field-shell` | First correction committed — final bounded correction running | `a7e8039` after `f80215d` | 8/8 focused; responsive browser gate; 256/256 existing; lint/build pass | HOLD: external command slot is below first viewport at iPad/Mac widths; nine-group/six-field Needs Me contract is not enforced at the type/validation boundary | Final correction in progress | Pending | — |
| B Paint/Clean TurnBoard | `/Users/los/Documents/PDS-jul28-turnboard` | `codex/jul28-turnboard` | First correction committed — final bounded correction running | `6cd5886` after `141e392` | 12/12 focused; 256/256 existing; 320px–Mac responsive browser checks; lint/build pass | HOLD: truncated sectionOrder can still false-complete; Access blocked filter mixes blocker types; Unit card remains one oversized semantic button | Final correction in progress | Pending | — |
