...
- [ ] Current code slice is D3 Units Scan Upgrade.
  - [ ] Make the Units page easier to scan on iPhone.
  - [ ] Keep quick unit status actions obvious without crowding cards.
  - [ ] Preserve performance limits for large unit lists.
