...
- Added initial project operating-system layout.
- Added Demo Mode vs Real Turn Mode, Start Real Turn setup, backup-before-reset reset flow, and project-scoped crew contacts.
