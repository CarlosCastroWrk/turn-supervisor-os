...
- Preview-first bulk Unit updates with active-Turn scope, a 500-Unit cap, stale-preview skips, protected transition rules, durable apply, reload persistence, and mobile selection layout
