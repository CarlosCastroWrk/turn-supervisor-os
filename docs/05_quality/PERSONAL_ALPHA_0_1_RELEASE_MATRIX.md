...
| F. Walk | Eligible work only; trade/section outcomes survive navigation and reload; no official approval inferred | Track C walk browser and field-activation browser | **PASS.** Paint/Clean and Common/A–E remain trade/section specific; paper remains authoritative. |
